# Health Data Pipeline - Promptly Technical Assessment

A production-grade ELT pipeline that ingests patient data from Google Sheets, transforms it into a standardised **FHIR Format**, and loads it into Snowflake — with FHIR-aligned data quality checks, PII protection, orchestration, and monitoring.
